...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(aug_2016=txn_amt,
         ...
         aug_2016_cin_amt=cin_amt,
         aug_2016_non_cin_amt=non_cin_amt,
         aug_2016_promo_bonus_pt=promo_bonus_pt,
         aug_2016_enroll_bonus_pt=enroll_bonus_pt,
         aug_2016_regular_pt=regular_pt
         )%>%
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(jul_2016=txn_amt,
         ...
         jul_2016_non_cin_amt=non_cin_amt,
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(jun_2016=txn_amt,
         ...
         jun_2016_non_cin_amt=non_cin_amt,
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(may_2016=txn_amt,
         ...
         may_2016_non_cin_amt=non_cin_amt,
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(apr_2016=txn_amt,
         ...
         apr_2016_non_cin_amt=non_cin_amt,
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(mar_2016=txn_amt,
         ...
         mar_2016_non_cin_amt=non_cin_amt,
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(feb_2016=txn_amt,
         ...
         feb_2016_non_cin_amt=non_cin_amt,
...
y <- "aug_2016.y"  
x <- names[names(scene_data)!=y & names(scene_data)!="aug_2016.x"] 
