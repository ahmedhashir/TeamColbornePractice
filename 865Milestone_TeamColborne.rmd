...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(aug_2016=txn_amt,
         aug_2016_cin=cin_pt_n,
         n_aug_2016=n_pt,
         aug_2016_issuance_amt=issuance_amt,
         aug_2016_reversal_amt=reversal_amt,
         aug_2016_issuance_pt=issuance_pt,
         aug_2016_reversal_pt=reversal_pt,
         aug_2016_redeem_amt=redeem_amt,
         aug_2016_redeem_pt=redeem_pt,
         aug_2016_cin_pt=cin_pt,
         aug_2016_non_cin_pt=non_cin_pt,
         aug_2016_non_cin_amt=cin_amt,
         aug_2016_non_non_cin_amt=non_cin_amt,
         aug_2016_non_promo_bonus_pt=promo_bonus_pt,
         aug_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         aug_2016_non_regular_pt=regular_pt
         )%>%
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(jul_2016=txn_amt,
         ...
         jul_2016_non_cin_amt=cin_amt,
         jul_2016_non_non_cin_amt=non_cin_amt,
         jul_2016_non_promo_bonus_pt=promo_bonus_pt,
         jul_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         jul_2016_non_regular_pt=regular_pt
         )%>%
  right_join(y=scene_joined, by="scene_mbr_key")
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(jun_2016=txn_amt,
         ...
         jun_2016_non_cin_amt=cin_amt,
         jun_2016_non_non_cin_amt=non_cin_amt,
         jun_2016_non_promo_bonus_pt=promo_bonus_pt,
         jun_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         jun_2016_non_regular_pt=regular_pt
         )%>%
  right_join(y=scene_joined, by="scene_mbr_key")
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(may_2016=txn_amt,
         ...
         may_2016_non_cin_amt=cin_amt,
         may_2016_non_non_cin_amt=non_cin_amt,
         may_2016_non_promo_bonus_pt=promo_bonus_pt,
         may_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         may_2016_non_regular_pt=regular_pt
         )%>%
  right_join(y=scene_joined, by="scene_mbr_key")
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(apr_2016=txn_amt,
         ...
         apr_2016_non_cin_amt=cin_amt,
         apr_2016_non_non_cin_amt=non_cin_amt,
         apr_2016_non_promo_bonus_pt=promo_bonus_pt,
         apr_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         apr_2016_non_regular_pt=regular_pt
         )%>%
  right_join(y=scene_joined, by="scene_mbr_key")
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(mar_2016=txn_amt,
         ...
         mar_2016_non_cin_amt=cin_amt,
         mar_2016_non_non_cin_amt=non_cin_amt,
         mar_2016_non_promo_bonus_pt=promo_bonus_pt,
         mar_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         mar_2016_non_regular_pt=regular_pt
         )%>%
  right_join(y=scene_joined, by="scene_mbr_key")
...
scene_joined<-scene_loyalty_pt%>%
  ...
  rename(feb_2016=txn_amt,
         ...
         feb_2016_non_cin_amt=cin_amt,
         feb_2016_non_non_cin_amt=non_cin_amt,
         feb_2016_non_promo_bonus_pt=promo_bonus_pt,
         feb_2016_non_enroll_bonus_pt=enroll_bonus_pt,
         feb_2016_non_regular_pt=regular_pt
         )%>%
  right_join(y=scene_joined, by="scene_mbr_key")
...
scene_joined <- scene_joined %>%
  filter( (feb_2016 > 0 & mar_2016 > 0 & apr_2016 > 0 
         ...
         # ( feb_2016_redeem_pt > 0 | mar_2016_redeem_pt > 0 | apr_2016_redeem_pt > 0 
         #   | may_2016_redeem_pt > 0 | jun_2016_redeem_pt > 0 | jul_2016_redeem_pt > 0
         #   | aug_2016_redeem_pt > 0 )
         ) %>%
  select(everything())
...
h2o.init(ip = "192.168.30.21", port = 56526)
